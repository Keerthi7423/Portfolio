      ...
      <div className="relative p-6 md:p-8 bg-surface/50 backdrop-blur-md border border-white/10 rounded-xl overflow-hidden hover:border-arc-blue/30 transition-colors duration-500 group">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-3">
            <h4 className="text-[10px] font-orbitron text-text-secondary tracking-[0.3em] uppercase mb-4">Mission Objectives Achieved</h4>
          ...
          <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
            <span className="text-[9px] font-ibm-mono text-text-secondary/40 tracking-tighter">
              LOG_ID: {exp.id} // SECURE_TRANS
            </span>
            <div className="flex items-center gap-1 text-[9px] font-orbitron text-arc-blue/60 group-hover:text-arc-blue transition-colors tracking-widest uppercase">
